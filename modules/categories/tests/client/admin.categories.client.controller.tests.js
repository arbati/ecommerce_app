  ...
  describe('Categories Admin Controller Tests', function () {
    ...
    describe('vm.save() as create', function () {
      ...
      it('should send a POST request with the form input values and then locate to new object URL', inject(function (CategoriesService) {
        ...
        expect(Notification.success).toHaveBeenCalledWith({ message: '<i class="glyphicon glyphicon-ok"></i> Category saved successfully!' });
      ...
      it('should call Notification.error if error', function () {
        ...
        expect(Notification.error).toHaveBeenCalledWith({ message: errorMessage, title: '<i class="glyphicon glyphicon-remove"></i> Category save error!' });
      });
    });
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the category and redirect to categories', function () {
        ...
        expect(Notification.success).toHaveBeenCalledWith({ message: '<i class="glyphicon glyphicon-ok"></i> Category deleted successfully!' });
        expect($state.go).toHaveBeenCalledWith('admin.categories.list');
      });
