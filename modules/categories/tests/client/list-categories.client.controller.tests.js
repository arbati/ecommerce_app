  ...
  describe('Categories List Controller Tests', function () {
    ...
    describe('Instantiate', function () {
      ...
      it('should send a GET request and return all categories', inject(function (CategoriesService) {
        // Set POST response
        $httpBackend.expectGET('/api/categories').respond(mockArticleList);
        ...
        expect($scope.vm.categories[0]).toEqual(mockArticle);
        expect($scope.vm.categories[1]).toEqual(mockArticle);
